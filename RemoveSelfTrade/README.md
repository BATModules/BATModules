...
### **Documentation & code**
Full documentation including technical details on how to link the module to a target model is provided in the BATModel Wiki page for the [self-trade removal module](https://github.com/BATModules/BATModules/wiki/RST-Module-%E2%80%90-Remove-self%E2%80%90trade-from-aggregated-GTAP-regions). Code is provided in [GEMPACK](/RemoveSelfTrade/GEMPACK) in both Visual Gtree (*gmp*) and standard GEMPACK (*tab*) file format.
